                ...
                <div class="col-12">
                    <table border="0" style="margin-left: unset">
                        ...
                        <tr>
                            ...
                            <td><a href="./docs/valasztas_2024/jm_ekepv_nyilv_vetel_donka_krisztian.pdf" target="_blank">Letöltés<i class="fa-solid fa-menu fa-file-pdf"></i></a></td>
                        </tr>
                        <tr>
                            <td>Dr. Kun Gábor Zoltán - egyéni listás képviselő-jelölt nyilvántartásba vétele</td>
                            <td><a href="./docs/valasztas_2024/jm_ekepv_nyilv_vetel_dr_kun_gabor.pdf" target="_blank">Letöltés<i class="fa-solid fa-menu fa-file-pdf"></i></a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><a href="./docs/valasztas_2024/jm_ekepv_nyilv_vetel_orszag_jozsef.pdf" target="_blank">Letöltés<i class="fa-solid fa-menu fa-file-pdf"></i></a></td>
                        </tr>
                        <tr>
                            <td>Papp János - egyéni listás képviselő-jelölt nyilvántartásba vétele</td>
                            <td><a href="./docs/valasztas_2024/jm_ekepv_nyilv_vetel_papp_janos.pdf" target="_blank">Letöltés<i class="fa-solid fa-menu fa-file-pdf"></i></a></td>
                        </tr>
                        <tr>
                            <td>Saliga Csaba - egyéni listás képviselő-jelölt nyilvántartásba vétele</td>
                            <td><a href="./docs/valasztas_2024/jm_ekepv_nyilv_vetel_saliga_csaba.pdf" target="_blank">Letöltés<i class="fa-solid fa-menu fa-file-pdf"></i></a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><a href="./docs/valasztas_2024/jm_ekepv_nyilv_vetel_szabo_istvan.pdf" target="_blank">Letöltés<i class="fa-solid fa-menu fa-file-pdf"></i></a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><a href="./docs/valasztas_2024/jm_ekepv_nyilv_vetel_tar_gabriella.pdf" target="_blank">Letöltés<i class="fa-solid fa-menu fa-file-pdf"></i></a></td>
                        </tr>
                        <tr>
                            <td>Harcos Imre Richárd - nemzetiségi képviselő-jelölt nyilvántartásba vétele</td>
                            <td><a href="./docs/valasztas_2024/jm_nkepv_nyilv_vetel_harcos_imre_richard.pdf" target="_blank">Letöltés<i class="fa-solid fa-menu fa-file-pdf"></i></a></td>
                        </tr>
                        <tr>
