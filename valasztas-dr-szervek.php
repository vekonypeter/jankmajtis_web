            ...
            <div class="row new">
                ...
                <div class="col-12">
                    ...
                    <table border="0" style="margin-left: unset">
                        <tr>
                            <td>
                                <p> <!-- using p for more padding to make this stand out a bit from other docs -->
                                    Jelentkezzen szavazatszámláló bizottsági tagnak az országgyűlési választásokra!<br />
